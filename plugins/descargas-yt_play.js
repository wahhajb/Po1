...
{ header: "𓃠 𝗔 𝗨 𝗗 𝗜 𝗢   𝗗 𝗢 𝗖", title: "", id: `${usedPrefix}play.1${yt_play[0].url}`, description: `${yt_play[0].title}\n` },
...
ও *رابط الفديو*
» *${yt_play[0].url}*
> انا غير مسئول عن موسيقى    `,  `اختار يحب` listSections, {quoted: fkontak});
} catch (e) {
