...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    let pp = 'https://telegra.ph/file/30dd74de637f1a31c8e09.jpg';
    ...
    if (!lister.includes(feature)) {
        return conn.sendButton(m.chat, cap, 'ستيڤن-بوت', pp, [['دولـة',`${usedPrefix + command} دولة`]], null, null, m);
    }
    ...
    if (feature === "دولة") {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, ' ستيفن>بوت', pp, [['حاول مجددا',`${usedPrefix + command} أرقام ${additionalLink}`]], null, null, m);
        }
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '.ستيفن', pp, [['حاول مجددا',`${usedPrefix + command} رسائل ${additionalLink}`]], null, null, m);
        }
    } else if (feature === "كود") {
        if (!additionalLink) {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, 'ستيفن-𝐵𝛩𝑇', pp, [['حاول مجددا',`${usedPrefix + command} كود ${additionalLink}`]], null, null, m);
        }
    }
};
