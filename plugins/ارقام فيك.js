...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    let pp = 'https://telegra.ph/file/3dacacfc87f805433e551.png';
    ...
    if (feature === "دولة") {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, ' 𝐵𝛩𝑇 𝐸𝐿𝐴𝐾𝑅𝐴𝐵', pp, [['حاول مجددا',`${usedPrefix + command} أرقام ${additionalLink}`]], null, null, m);
        }
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '𝐸𝐿𝐴𝐾𝑅𝐸𝐵-𝐵𝛩𝑇', pp, [['حاول مجددا',`${usedPrefix + command} رسائل ${additionalLink}`]], null, null, m);
        }
    } else if (feature === "كود") {
        if (!additionalLink) {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '𝐸𝐿𝐴𝐾𝑅𝐸𝐵-𝐵𝛩𝑇', pp, [['حاول مجددا',`${usedPrefix + command} كود ${additionalLink}`]], null, null, m);
        }
    }
};
