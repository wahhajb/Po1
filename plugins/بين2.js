...
if (!text) throw `*ما الذي تبحث عنه في بينترست*` 
try {
...
conn.sendButton(m.chat, `نتائج عن ${text}`, `𝙋𝙞𝙣𝙩𝙚𝙧𝙚𝙨𝙩 | ${wm}`, json.getRandom(), [
['غيرها', `${usedPrefix}بين2 ${text}`]], null, null, m)
...
handler.command = /^(بين2|pinterestdl)$/i
