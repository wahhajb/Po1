...
const smsAvisoAG = () => { return `╰⊱⚠️⊱ تنبيه مهم ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ معلومة ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ خطأ ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ استخدم الأمر بشكل صحيح ⊱❗️⊱╮\n\n` }
...
const smsGroup = () => { return `\`\`\`〔✘ هــذا الامــر فـي القروبات فــقــط〕\`\`\`` }
const smsPrivate = () => { return `\`\`\`〔✘ هــذا الامــر فـي الــخــاص فــقــط〕\`\`\`` }
const smsAdmin = () => { return `\`\`\`〔✘ هــذا الامــر خــاص ل مــشــرفــيــن الــقــروب〕\`\`\`` }
...
const smsLista1 = () => { return `🌟 معلومات زينون بوت 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت زينون بوت 🐈`}
...
const smsBye = () => { return '
const smsSpromote = () => { return '**[ 👑 ] @user تمت ترقيته إلى المسؤول.*'}
const smsSdemote = () => { return '*[ 👑 ] @user تم تخفيض رتبته من المسؤول.*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'ستيفن↳🐢↲𝐁𝐎𝐓'}
...
const smsSoloOwner = () => { return `*يجب على مطوري تنشيط الوظيفة*\n*#on restrict*`}
...
//نص
const smsConMenu = () => { return `لـلـاوامـر ✅`}
...
const eGataCoins = () => { return '🐱 MadaraCoins' }
const eGataTickers = () => { return '🎫 Madara Tickers' } 
